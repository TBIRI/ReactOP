      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden" role="banner" aria-label="Section hero" data-section="hero"  itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="relative z-10 text-center w-full max-w-7xl px-4 -mt-6 sm:-mt-8">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl mb-10 lg:mb-12 text-gray-400 max-w-4xl mx-auto" itemProp="description">
            Optimisation <span className="bg-gradient-to-r from-gray-200 to-blue-300 bg-clip-text text-transparent">Google Ads</span> et <span className="bg-gradient-to-r from-gray-200 to-blue-300 bg-clip-text text-transparent">pages de destination</span> raffinées pour plus de demandes qualifiées.
          </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="p-8 sm:p-10 lg:p-12 bg-gray-900/50 border border-green-500/20 rounded-2xl text-center" data-value-proposition="main">
              <p className="text-xl sm:text-2xl lg:text-3xl bg-gradient-to-r from-gray-200 to-blue-200 bg-clip-text text-transparent font-medium">
                Nous identifions les axes d'amélioration du parcours d'acquisition et activons les leviers clés afin d'augmenter le volume de demandes qualifiées
              </p>
            </div>
          </div>
        </div>
