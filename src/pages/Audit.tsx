...
function Audit() {
  ...
  return (
    <div className="min-h-screen bg-black text-white" style={{ margin: 0, height: '100vh', overflow: 'hidden' }}>
      <div
      ...
      <iframe
        ...
        style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, border: 0, zIndex: 10 }}
      />
    </div>
  );
}
