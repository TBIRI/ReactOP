        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 sm:gap-20 lg:gap-24 items-center">
            <div itemScope itemType="https://schema.org/Organization" className="opacity-0 scroll-reveal-target">
              <h2 id="contact-title" className="font-display text-[3rem] leading-[1.4] sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-16 sm:mb-24 lg:mb-32 pb-12 pr-4">
                <span className="text-white">Parlons-</span>
                <span className="bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent italic pr-2">en!</span>
              </h2>
