...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white" itemScope itemType="https://schema.org/WebPage">
      ...
      <section className="h-[100svh] sm:h-[100vh] flex flex-col items-center justify-center px-4 sm:px-6 relative overflow-hidden gpu-accelerated pt-24 sm:pt-32 md:pt-0" role="banner" aria-label="Section hero" data-section="hero"  itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="relative z-10 w-full max-w-7xl px-2 sm:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 lg:col-start-1">
              <h1 className="font-display text-[2.5rem] leading-[1.2] sm:text-[4rem] md:text-[100px] lg:text-[120px] font-bold bg-gradient-to-br from-white via-blue-100 to-blue-400 bg-clip-text text-transparent mb-6 sm:mb-8 lg:mb-10 md:leading-[1.12] pb-4 animate-slide-in-stagger-1" itemProp="name headline">
